...
export const Header: React.FC<HeaderProps> = ({ scrollY, isMenuOpen, setIsMenuOpen }) => {
  return (
    <>
      ...
      {/* Mobile Menu Dropdown - rendered inside Header so it works on ALL pages */}
      {isMenuOpen && (
        <div className="lg:hidden fixed inset-x-0 top-[64px] bg-amber-50/95 backdrop-blur-lg shadow-xl z-40">
