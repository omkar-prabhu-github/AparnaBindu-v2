      ...
      <div className="relative z-10 flex flex-col flex-grow w-full">
        ...
        <main className="container mx-auto px-4 sm:px-6 md:px-10 pt-16 md:pt-20 pb-24 flex-grow">
          ...
          <section className="text-center max-w-5xl mx-auto mb-16 relative">
            ...
            >
              <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold font-serif mb-4 sm:mb-6 text-transparent bg-clip-text bg-gradient-to-r from-amber-900 via-orange-800 to-red-900 leading-tight mt-4">
                Our Journey with <br /> Aparna Bindu
              </h1>

              <p className="text-base sm:text-xl md:text-2xl text-amber-800/90 leading-relaxed font-medium max-w-3xl mx-auto">
          ...
          <section className="max-w-5xl mx-auto mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Step 1 */}
              <motion.div
                className="bg-white/40 backdrop-blur-lg rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-white/60 shadow-xl hover:shadow-amber-500/10 transition-all duration-300 relative overflow-hidden group"
              ...
              >
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-serif text-amber-900 mb-3 relative z-10">Version 1.0: The CNN Model</h3>
              ...
              {/* Step 2 */}
              <motion.div
                className="bg-white/40 backdrop-blur-lg rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-white/60 shadow-xl hover:shadow-orange-500/10 transition-all duration-300 relative overflow-hidden group"
                initial={{ opacity: 0, x: 30 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true, margin: "50px" }}
              >
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-serif text-amber-900 mb-3 relative z-10">Version 2.0: The Hybrid Model</h3>
                <p className="text-amber-800/90 leading-relaxed relative z-10">
              ...
              >
                <div className="bg-amber-50/95 backdrop-blur-xl rounded-[22px] p-8 md:p-12 h-full relative overflow-hidden">
                  ...
                  <div className="relative z-10 max-w-4xl">
                    ...
                    <h3 className="text-2xl sm:text-3xl md:text-5xl font-bold font-serif text-transparent bg-clip-text bg-gradient-to-r from-orange-800 to-red-800 mb-5">
                      SIH Finalists
                    </h3>
          ...
          <section className="mb-24 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto relative z-10">
              <div className="bg-white/50 backdrop-blur-md rounded-2xl sm:rounded-3xl p-6 sm:p-10 border border-amber-200/60 hover:border-amber-400 transition-colors shadow-lg group">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-serif text-amber-900 mb-4">Deep Classification Engine</h3>
              ...
              <div className="bg-white/50 backdrop-blur-md rounded-2xl sm:rounded-3xl p-6 sm:p-10 border border-amber-200/60 hover:border-amber-400 transition-colors shadow-lg group">
                ...
                <h3 className="text-xl sm:text-2xl font-bold font-serif text-amber-900 mb-4">Interactive Kolam Designer</h3>
                <p className="text-amber-800 leading-relaxed">
